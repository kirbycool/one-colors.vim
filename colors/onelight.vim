...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi StatusLine ctermbg=NONE ctermfg=NONE cterm=NONE guibg=#a0a1a7 guifg=#383a42 gui=NONE
    hi StatusLineNC ctermbg=NONE ctermfg=NONE cterm=NONE guibg=NONE guifg=#696c77 gui=NONE
    hi TabLine ctermbg=NONE ctermfg=NONE cterm=NONE guibg=#a0a1a7 guifg=#383a42 gui=NONE
    hi TabLineFill ctermbg=NONE ctermfg=NONE cterm=NONE guibg=NONE guifg=NONE gui=NONE
    hi TabLineSel ctermbg=NONE ctermfg=NONE cterm=NONE guibg=#696c77 guifg=#383a42 gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi TabLineSel ctermbg=darkgray ctermfg=black cterm=NONE
